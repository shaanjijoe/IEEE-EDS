  ...
  return (
    <div>
      {/* <div className="header">
        <div className="logo">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/IEEE_logo.svg/1200px-IEEE_logo.svg.png" alt="IEEE Logo" />
          <h1>IEEE NTC Student Branch Chapter</h1>
        </div>
        <div className="nav">
          <ul>
            <li>
